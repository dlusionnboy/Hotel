...
<div id="modalForm" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tarif Kamar</h4>
                <button class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="formkamartarifkamu" method="post" action="<?=base_url('kamartarif') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tipetarif_id" class="form-control">
                    </div>
                </form>
    ...
    $(document).ready(function() {
        ...
        $('form#formkamartarifkamu').submitAjax({
            pre: () => {
        ...
        $('button#btn-menambahkan').on('click', function() {
            $('form#formkamartarifkamu').submit();
        ...
        $('button#btn-tambah').on('click', function() {
            ...
            $('form#formkamartarifkamu').trigger('reset');
            $('input[name=_method]').val('');
        });

        $('table#table-kamartarif').on('click', '.btn-light', function() {
            let id = $(this).data('id');
        ...
        $('table#table-kamartarif').on('click', '.btn-danger', function() {

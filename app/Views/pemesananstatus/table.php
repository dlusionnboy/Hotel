...
<div id="modalForm" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formstatuspemesanan" method="post" action="<?=base_url('pemesananstatus') ?>">
    ...
    $(document).ready(function() {
        ...
        $('form#formstatuspemesanan').submitAjax({
            pre: () => {
        ...
        $('button#btn-menambahkan').on('click', function() {
            $('form#formstatuspemesanan').submit();
        ...
        $('button#btn-tambah').on('click', function() {
            ...
            $('form#formstatuspemesanan').trigger('reset');
            $('input[name=_method]').val('');
        });

        $('table#table-pemesananstatus').on('click', '.btn-light', function() {
            let id = $(this).data('id');
        ...
        $('table#table-pemesananstatus').on('click', '.btn-danger', function() {

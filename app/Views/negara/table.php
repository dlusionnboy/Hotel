...
<div id="modalForm" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formnegaraku" method="post" action="<?=base_url('negara') ?>">
    ...
    $(document).ready(function() {
        ...
        $('button#btn-tambah').on('click', function() {
            ...
            $('form#formnegaraku').trigger('reset');
            $('input[name=_method]').val('');
        });

        $('table#table-negara').on('click', '.btn-light', function() {
            let id = $(this).data('id');
        ...
        $('table#table-negara').on('click', '.btn-danger', function() {
